...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('apply', function (Blueprint $table) {
            ...
            $table->string('apply_no', 30)->nullable()->comment('申請編號');
            $table->string('apply_name', 120)->nullable()->comment('申請作業');
            $table->string('project_no', 30)->nullable()->comment('專案編號');
            $table->string('project_name', 120)->nullable()->comment('專案名稱');
            ...
            $table->string('file', 120)->nullable()->comment('合約文件下載');
            $table->timestamps();
        });
    }
