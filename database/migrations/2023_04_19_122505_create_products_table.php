...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->string('product_type_id', 36)->nullable()->comment('產品類型');
            $table->string('sales_type_id', 36)->nullable()->comment('銷售模式');
            $table->string('fee_rate_id', 36)->nullable()->comment('使用費率');
            ...
            $table->integer('rent_month')->nullable()->default(0)->comment('產品月租費用');
            $table->integer('deposit_amount')->nullable()->default(0)->comment('產品保證金');
