...
class PlanApply extends AbstractModel
{
    ...
    public function getFieldProperties()
    {
        return [
            ...
            [
                ...
                'error_msg' => json_encode([
                    ['customer_name.required'=>'用戶名稱請勿空白']
                ]),
            ],
            [
                'field' => 'status',
