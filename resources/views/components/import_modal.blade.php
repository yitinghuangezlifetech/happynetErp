<div class="modal fade" id="importForm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="importForm" method="POSt" action="{{ route($menu->slug . '.importData') }}"
                        ...
                        @if ($menu->slug == 'dial_records')
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="file">費率類型</label>
                                    <select class="form-control" name="rate_type_id" required>
                                        <option value="">請選擇</option>
                                        @foreach ($rateTypes->getChildNoFilter ?? [] as $type)
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" name="file" value="" id="file"
                                    placeholder="請上傳檔案" accept=".xlsx,.xls,.csv,.txt">
                            </div>
                        </div>
                    </div>
                </div>
