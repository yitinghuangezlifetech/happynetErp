        ...
        <div class="card card-secondary">
            ...
            <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="data_source_id" id="data_source_id">
                                ...
                                @foreach ($dataSource->getChilds ?? [] as $source)
                                    <option value="{{ $source->id }}" @if($data->data_source_id == $source->id){{'selected'}}@endif>{{ $source->type_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="system_no" value="{{ $data->system_no }}"
                                id="system_no" placeholder="請輸入系統編號"
                                @if ($user->role->super_admin == 1) {{ 'required' }}@else {{ 'disabled' }} @endif>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="organization_type_id" id="organization_type_id"
                                ...
                                @foreach ($organizationTypes->getChilds ?? [] as $organizationType)
                                    <option value="{{ $organizationType->id }}"
                                        @if ($data->organization_type_id == $organizationType->id) {{ 'selected' }} @endif>
                                        {{ $organizationType->type_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="identity_id" id="identity_id"
                                @if ($user->role->super_admin == 1) {{ 'required' }}@else {{ 'disabled' }} @endif>
                                <option value="">請選擇</option>
                                @foreach ($identities->getChilds ?? [] as $identity)
                                    <option value="{{ $identity->id }}"
                                        @if ($data->identity_id == $identity->id) {{ 'selected' }} @endif>
                                        {{ $identity->type_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                            ...
                            <select class="form-control" name="parent_id" id="parent_id"
                                ...
                                @foreach ($organizations ?? [] as $organization)
                                    <option value="{{ $organization->id }}"
                                        @if ($data->parent_id == $organization->id) {{ 'selected' }} @endif>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="fee_rate_id">使用費率表</label>
                            <select class="form-control" name="fee_rate_id" id="fee_rate_id">
                                <option value="">請選擇</option>
                                @foreach ($feeRates ?? [] as $rate)
                                    <option value="{{ $rate->id }}"
                                        @if ($data->fee_rate_id == $rate->id) {{ 'selected' }} @endif>{{ $rate->name }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="manager_id_no" id="manager_id_no"
                                value="{{ $data->manager_id_no }}" required>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="mobile"><span style="color:red">*</span>行動電話(ex:<span
                                    style="color:red;size:12px">0988123456</span>)</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>市話</label><br>
                            <input type="tel" class="form-control-6" name="tel" value="{{ $data->tel }}"
                                id="tel" placeholder="市話號碼" pattern="^\d+$">#
                            <input type="tel" class="form-control-4" name="tel_1" value="{{ $data->tel_1 }}"
                                id="tel_1" placeholder="分機號碼" pattern="^\d+$">
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group clearfix">
                            ...
                            <input type="email" class="form-control" name="email" value="{{ $data->email }}"
                                id="email" placeholder="請輸入Email" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="official_website">官網</label>
                            <input type="text" class="form-control" name="official_website"
                                value="{{ $data->official_website }}" id="official_website" placeholder="請輸入官網網址">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group clearfix">
                            ...
                            <input type="date" class="form-control" name="expiry_day"
                                value="{{ $data->expiry_day }}" id="expiry_day" placeholder="請選擇日期" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="bill_day"><span style="color:red">*</span>每月結算日</label>
                            <input type="text" class="form-control" name="bill_day" value="{{ $data->bill_day }}"
                                id="bill_day" placeholder="請輸入數字" pattern="^\d+$" required>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group clearfix">
                            ...
                            <input type="text" class="form-control" name="attach_number_limit"
                                value="{{ $data->attach_number_limit }}" id="attach_number_limit"
                                placeholder="請輪入附掛號碼限制數" pattern="^\d+$" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="phone_call_limit"><span style="color:red">*</span>最大通話總數</label>
                            <input type="text" class="form-control" name="phone_call_limit"
                                value="{{ $data->phone_call_limit }}" id="phone_call_limit" placeholder="請輸入數字"
                                pattern="^\d+$" required>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group clearfix">
                            <div class="d-inline">
                                <input type="text" class="form-control" name="bill_address"
                                    value="{{ $data->bill_address }}" id="bill_address" placeholder="請輸入地址" required>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group clearfix">
                            <div class="d-inline">
                                <input type="text" class="form-control" name="business_address"
                                    value="{{ $data->business_address }}" id="business_address" placeholder="請輸入地址"
                                    required>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="bill_contact" id="bill_contact"
                                value="{{ $data->bill_contact }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="bill_contact_line">帳務聯絡人-line</label>
                            <input type="text" class="form-control" name="bill_contact_line" id="bill_contact_line"
                                value="{{ $data->bill_contact_line }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="bill_contact_mobile"><span style="color:red">*</span>帳務聯絡人-手機(ex:<span
                                    style="color:red;size:12px">0988123456</span>)</label>
                            <input type="number" class="form-control" name="bill_contact_mobile"
                                id="bill_contact_mobile" value="{{ $data->bill_contact_mobile }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>帳務聯絡人-市話</label><br>
                            <input type="tel" class="form-control-6" name="bill_contact_tel"
                                value="{{ $data->bill_contact_tel }}" id="bill_contact_tel" placeholder="市話號碼"
                                pattern="^\d+$">#
                            <input type="tel" class="form-control-4" name="bill_contact_tel_1"
                                value="{{ $data->bill_contact_tel_1 }}" id="bill_contact_tel_1" placeholder="分機號碼"
                                pattern="^\d+$">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="bill_contact_mail" id="bill_contact_mail"
                                value="{{ $data->bill_contact_mail }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="bill_contact_mail_1">帳務聯絡人信箱2</label>
                            <input type="email" class="form-control" name="bill_contact_mail_1"
                                id="bill_contact_mail_1" value="{{ $data->bill_contact_mail_1 }}">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="setup_contact" id="setup_contact"
                                value="{{ $data->setup_contact }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="setup_contact_line">裝機聯絡人-line</label>
                            <input type="text" class="form-control" name="setup_contact_line" id="setup_contact_line"
                                value="{{ $data->setup_contact_line }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="setup_contact_mobile"><span style="color:red">*</span>裝機聯絡人-手機(ex:<span
                                    style="color:red;size:12px">0988123456</span>)</label>
                            <input type="number" class="form-control" name="setup_contact_mobile"
                                id="setup_contact_mobile" value="{{ $data->setup_contact_mobile }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>裝機聯絡人-市話</label><br>
                            <input type="tel" class="form-control-6" name="setup_contact_tel"
                                value="{{ $data->setup_contact_tel }}" id="setup_contact_tel" placeholder="市話號碼"
                                pattern="^\d+$">#
                            <input type="tel" class="form-control-4" name="setup_contact_tel_1"
                                value="{{ $data->setup_contact_tel_1 }}" id="setup_contact_tel_1" placeholder="分機號碼"
                                pattern="^\d+$">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="setup_contact_mail" id="setup_contact_mail"
                                value="{{ $data->setup_contact_mail }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="setup_contact_mail_1">裝機聯絡人信箱2</label>
                            <input type="email" class="form-control" name="setup_contact_mail_1"
                                id="setup_contact_mail_1" value="{{ $data->setup_contact_mail_1 }}">
                        </div>
                    </div>
                </div>
            </div>
