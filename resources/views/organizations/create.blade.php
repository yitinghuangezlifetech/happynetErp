  ...
  <div class="card card-secondary">
    ...
    <div class="card-body">
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="system_no" value="" id="system_no" placeholder="請輸入系統編號" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            ...
            <select class="form-control" name="organization_type_id" id="organization_type_id">
              ...
              <option value="{{$organizationType->id}}">{{$organizationType->type_name}}</option>
              @endforeach
            </select>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <select class="form-control" name="identity_id" id="identity_id" required>
              ...
              <option value="{{$identity->id}}">{{$identity->type_name}}</option>
              @endforeach
            </select>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label for="parent_id">所屬組織</label>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="manager" id="manager" value="" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label for="manager_id_no"><span style="color:red">*</span>負責人身份字號</label>
            <input type="text" class="form-control" name="manager_id_no" id="manager_id_no" value="" required>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="form-group">
            <label>市話</label><br>
            <input type="tel" class="form-control-6" name="tel" value="" id="tel" placeholder="市話號碼" pattern="^\d+$">#
            <input type="tel" class="form-control-4" name="tel_1" value="" id="tel_1" placeholder="分機號碼" pattern="^\d+$">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="form-group clearfix">
            ...
            <input type="text" class="form-control" name="fax" value="" id="fax" placeholder="請輸入傳真號碼">
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label for="line">line</label>
            <input type="text" class="form-control" name="line" value="" id="line" placeholder="請輸入line">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="form-group clearfix">
            ...
            <input type="email" class="form-control" name="email" value="" id="email" placeholder="請輸入Email" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label for="official_website">官網</label>
            <input type="text" class="form-control" name="official_website" value="" id="official_website" placeholder="請輸入官網網址">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="form-group clearfix">
            ...
            <input type="date" class="form-control" name="expiry_day" value="" id="expiry_day" placeholder="請選擇日期" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label for="bill_day"><span style="color:red">*</span>每月結算日</label>
            <input type="text" class="form-control" name="bill_day" value="" id="bill_day" placeholder="請輸入數字" pattern="^\d+$" required>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="form-group clearfix">
            ...
            <input type="text" class="form-control" name="attach_number_limit" value="1000000" id="attach_number_limit" placeholder="請輪入附掛號碼限制數" pattern="^\d+$" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label for="phone_call_limit"><span style="color:red">*</span>最大通話總數</label>
            <input type="text" class="form-control" name="phone_call_limit" value="1000" id="phone_call_limit" placeholder="請輸入數字" pattern="^\d+$" required>
          </div>
        </div>
      </div>
      <div class="row">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group clearfix">
            <div class="d-inline">
              <input type="text" class="form-control" name="bill_address" value="" id="address" placeholder="請輸入地址" required>
            </div>
          </div>
        </div>  
      </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group clearfix">
            <div class="d-inline">
              <input type="text" class="form-control" name="business_address" value="" id="address" placeholder="請輸入地址" required>
            </div>
          </div>
        </div>  
      </div>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="bill_contact" id="bill_contact" value="" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label for="bill_contact_line">帳務聯絡人-line</label>
            <input type="text" class="form-control" name="bill_contact_line" id="bill_contact_line" value="">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="number" class="form-control" name="bill_contact_mobile" id="bill_contact_mobile" value="" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label>帳務聯絡人-市話</label><br>
            <input type="tel" class="form-control-6" name="bill_contact_tel" value="" id="bill_contact_tel" placeholder="市話號碼" pattern="^\d+$">#
            <input type="tel" class="form-control-4" name="bill_contact_tel_1" value="" id="bill_contact_tel_1" placeholder="分機號碼" pattern="^\d+$">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="email" class="form-control" name="bill_contact_mail" id="bill_contact_mail" value="" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label for="bill_contact_mail_1">帳務聯絡人信箱2</label>
            <input type="email" class="form-control" name="bill_contact_mail_1" id="bill_contact_mail_1" value="">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="setup_contact" id="setup_contact" value="" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label for="setup_contact_line">裝機聯絡人-line</label>
            <input type="text" class="form-control" name="setup_contact_line" id="setup_contact_line" value="">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="number" class="form-control" name="setup_contact_mobile" id="setup_contact_mobile" value="" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label>裝機聯絡人-市話</label><br>
            <input type="tel" class="form-control-6" name="setup_contact_tel" value="" id="setup_contact_tel" placeholder="市話號碼" pattern="^\d+$">#
            <input type="tel" class="form-control-4" name="setup_contact_tel_1" value="" id="setup_contact_tel_1" placeholder="分機號碼" pattern="^\d+$">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="email" class="form-control" name="setup_contact_mail" id="setup_contact_mail" value="" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label for="setup_contact_mail_1">裝機聯絡人信箱2</label>
            <input type="email" class="form-control" name="setup_contact_mail_1" id="setup_contact_mail_1" value="">
          </div>
        </div>
      </div>
    </div>
