            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="id_no" id="id_no" value=""
                                required>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>市話</label><br>
                            <input type="tel" class="form-control-6" name="tel" value="" id="tel"
                                placeholder="市話號碼" pattern="^\d+$">#
                            <input type="tel" class="form-control-4" name="tel_1" value="" id="tel_1"
                                placeholder="分機號碼" pattern="^\d+$">
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="line" value="" id="line"
                                placeholder="請輸入line">
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="official_website" value=""
                                id="official_website" placeholder="請輸入官網網址">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group clearfix">
                            ...
                            <input type="date" class="form-control" name="expiry_day" value="" id="expiry_day"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="bill_day" value="" id="bill_day"
                                placeholder="請輸入數字" pattern="^\d+$" required>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group clearfix">
                            ...
                            <input type="text" class="form-control" name="attach_number_limit" value="1000000"
                                id="attach_number_limit" placeholder="請輪入附掛號碼限制數" pattern="^\d+$" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="phone_call_limit"><span style="color:red">*</span>最大通話總數</label>
                            <input type="text" class="form-control" name="phone_call_limit" value="1000"
                                id="phone_call_limit" placeholder="請輸入數字" pattern="^\d+$" required>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group clearfix">
                            <div class="d-inline">
                                <input type="text" class="form-control" name="bill_address" value=""
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="bill_contact_mobile"
                                id="bill_contact_mobile" value="" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>帳務聯絡人-市話</label><br>
                            <input type="tel" class="form-control-6" name="bill_contact_tel" value=""
                                id="bill_contact_tel" placeholder="市話號碼" pattern="^\d+$">#
                            <input type="tel" class="form-control-4" name="bill_contact_tel_1" value=""
                                id="bill_contact_tel_1" placeholder="分機號碼" pattern="^\d+$">
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="setup_contact_mobile"
                                id="setup_contact_mobile" value="" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>裝機聯絡人-市話</label><br>
                            <input type="tel" class="form-control-6" name="setup_contact_tel" value=""
                                id="setup_contact_tel" placeholder="市話號碼" pattern="^\d+$">#
                            <input type="tel" class="form-control-4" name="setup_contact_tel_1" value=""
                                id="setup_contact_tel_1" placeholder="分機號碼" pattern="^\d+$">
                        </div>
                    </div>
                </div>
                <div class="row">
