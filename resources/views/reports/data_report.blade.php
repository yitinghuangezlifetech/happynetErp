        ...
        <div class="card">
            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-bordered text-nowrap">
                    <thead>
                        <tr>
                            <th class="text-center">缺失開主時間</th>
                            <th class="text-center">複檢時間</th>
                            <th class="text-center">商家名稱</th>
                            <th class="text-center">屬性</th>
                            <th class="text-center">次屬性</th>
                            <th class="text-center">條文</th>
                            <th class="text-center">條文狀態</th>
                            <th class="text-center">所見事實</th>
                            <th class="text-center">委員名稱</th>
                            <th class="text-center">數值</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{optional($info->auditRoute)->store->name}}</td>
                            <td class="text-center">{{optional($info->mainAttribute)->name}}</td>
                            <td class="text-center">{{optional($info->subAttribute)->name}}</td>
                            <td class="text-center">{{optional($info->regulation)->clause}}</td>
                            <td class="text-center">
                                @switch($info->status)
                                    @case(1)
                                        合格
                            ...
                            <td class="text-center">{{optional($info->auditRoute)->mainUser->name}}</td>
                            <td class="text-center">
