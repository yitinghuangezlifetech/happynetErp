                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="contract_id" id="contract_id">
                                ...
                                @foreach ($contracts ?? [] as $contract)
                                    <option value="{{ $contract->id }}" data-plantype="{{ $contract->plan_type_id }}"
                                        data-applytype="{{ $contract->apply_type_id }}">{{ $contract->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="project_id" id="project_id">
                                ...
                                @foreach ($projects ?? [] as $project)
                                    <option value="{{ $project->id }}" data-applytype="{{ $project->apply_type_id }}">
                                        {{ $project->name }}</option>
                                @endforeach
                            </select>
                        </div>
            ...
            $('#organization_id').change(function() {
                ...
                $.ajax({
                    ...
                    success: function(rs) {
                        ...
                        rs.data.forEach(function(info) {
                            options +=
                                `<option value="${info.id}">${info.name}(帳號:${info.account})</option>`;
                        })
