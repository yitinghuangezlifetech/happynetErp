  ...
  <div class="card card-secondary" id="card_{{$k}}">
    <div class="card-header">
      ...
      <div class="card-tools">
        ...
        <button type="button" class="btn btn-tool removeAreaBtn" data-rows="{{$k}}"><i class="fas fa-times"></i></button>
      </div>
    </div>
    <div class="card-body">
      <div class="row">
        <div class="col-sm-6">
          <div class="form-group">
            <label for="call_target_id_{{$k}}"><span style="color:red">*</span>撥打對象</label>
            <select class="form-control callTarget" name="rates[{{$k}}][call_target_id]" id="call_target_id_{{$k}}" required>
              <option value="">請選擇</option>
              @foreach($callTargets??[] as $target)
              <option value="{{$target->id}}" @if($log->call_target_id==$target->id){{'selected'}}@endif>{{$target->type_name}}</option>
              @endforeach
            </select>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control callRate" name="rates[{{$k}}][call_rate]" id="call_rate_{{$k}}" value="{{$log->call_rate}}" data-rows="{{$k}}" required>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            <label for="discount_{{$k}}"><span style="color:red">*</span>折讓</label>
            <input type="text" class="form-control discout" name="rates[{{$k}}][discount]" id="discount_{{$k}}" value="{{$log->discount}}" data-rows="{{$k}}" required>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="rates[{{$k}}][discount_after_rate]" id="discount_after_rate_{{$k}}" value="{{$log->discount_after_rate}}" readonly>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
            <label for="charge_unit_{{$k}}"><span style="color:red">*</span>計費單位</label>
            <select class="form-control" name="rates[{{$k}}][charge_unit]" id="charge_unit_{{$k}}" required>
              <option value="">請選擇</option>
              <option value="1" @if($log->charge_unit == 1){{'selected'}}@endif>秒鐘</option>
              <option value="2" @if($log->charge_unit == 2){{'selected'}}@endif>分鐘</option>
            </select>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="rates[{{$k}}][parameter]" id="parameter_{{$k}}" value="{{$log->parameter}}" required>
          </div>
        </div>
      </div>
    </div>
