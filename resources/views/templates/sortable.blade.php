                        ...
                        <tbody id="items">
                            @foreach ($list ?? [] as $data)
                                <tr>
                                    ...
                                    <td class="text-center" style="vertical-align: middle"><i class="fas fa-arrows-alt"
                                          ...
                                          ';
                                                                ...
                                                                @case('image')
                                                                    @if (!empty($data->{$detail->field}))
                                                                        <img src="{{ $data->{$detail->field} }}"
                                                                            {{ app('BladeService')->imageResize($data->{$detail->field}) }}>
                                                                    @endif
                                                                @break
