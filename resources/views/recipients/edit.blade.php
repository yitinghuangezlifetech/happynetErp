        ...
        <div class="card card-secondary">
            ...
            @else
                ...
                @else
                    ...
                    @else
                        @if (
                            $detail->field == 'company_seal' ||
                                $detail->field == 'company_stamp' ||
                                $detail->field == 'sender_sign' ||
                                $detail->field == 'customer')
                            <div class="col-sm-6">
                        ...
                        @else
                            @if (
                                $detail->field != 'technician_id' &&
                                    $detail->field != 'technician_sign' &&
                                    $detail->field != 'auditor_id' &&
                                    $detail->field != 'auditor_sign' &&
                                    $detail->field != 'fail_response')
                                <div class="col-sm-6">
                                    @include('components.fields.' . $detail->type, [
                                        'type' => 'edit',
                                        'detail' => $detail,
                                                        ...
                                                        @if (isset($applyLogs[$log->product_type_id][$record->product_id]))
                                                            <tr>
                                                                <td class="text-center" style="vertical-align: middle"
                                                                    rowspan="{{ $record->product->feeRate->logs->count() + 1 }}">
                                                                    <input type="checkbox"
                                                                        name="products[{{ $i }}][product_id]"
                                                                        value="{{ $record->product_id }}"
                                                                        @if (isset($applyLogs[$log->product_type_id][$record->product_id])) {{ 'checked' }} @endif>{{ $record->product->name }}
                                                                    <input type="hidden"
                                                                        name="products[{{ $i }}][contract_id]"
                                                                        value="{{ $data->id }}">
                                                                    <input type="hidden"
                                                                        name="products[{{ $i }}][product_type_id]"
                                                                        value="{{ $log->product_type_id }}">
                                                                </td>
                                                            </tr>
                                                            @foreach ($record->product->feeRate->logs ?? [] as $k1 => $feeRateLog)
                                                                <tr>
                                                                    <td class="text-center" style="vertical-align: middle">
                                                                        <input type="checkbox"
                                                                            name="products[{{ $i }}][feeRates][{{ $k1 }}][call_target_id]"
                                                                            value="{{ $feeRateLog->call_target_id }}"
                                                                            @if (isset($applyLogs[$log->product_type_id][$record->product_id][$feeRateLog->call_target_id])) {{ 'checked' }} @endif>{{ $feeRateLog->target->type_name ?? '' }}
                                                                    </td>
                                                                    <td class="text-center" style="vertical-align: middle">
                                                                        {{ $feeRateLog->call_rate }}
                                                                        <input type="hidden"
                                                                            name="products[{{ $i }}][feeRates][{{ $k1 }}][call_rate]"
                                                                            id="call_rate_{{ $feeRateLog->id }}"
                                                                            value="{{ $feeRateLog->call_rate }}">
                                                                    </td>
                                                                    <td class="text-center" style="vertical-align: middle">
                                                                        @php
                                                                            $value = '';
                                                                        ...
                                                                        @endphp
                                                                        <input type="number"
                                                                            class="form-control feeRateDiscount"
                                                                            name="products[{{ $i }}][feeRates][{{ $k1 }}][discount]"
                                                                            data-logid="{{ $feeRateLog->id }}"
                                                                            value="{{ $value }}">
                                                                    </td>
                                                                    <td class="text-center" style="vertical-align: middle">
                                                                        @php
                                                                        ...
                                                                        <input type="number" class="form-control"
                                                                            name="products[{{ $i }}][feeRates][{{ $k1 }}][amount]"
                                                                            id="feeRateAmount_{{ $feeRateLog->id }}"
                                                                            data-logid="{{ $feeRateLog->id }}"
                                                                    ...
                                                                    <td class="text-center"
                                                                        ...
                                                                        @endif
                                                                        <input type="hidden"
                                                                            name="products[{{ $i }}][feeRates][{{ $k1 }}][charge_unit]"
                                                                            value="{{ $feeRateLog->charge_unit }}">
                                                                        <input type="hidden"
                                                                            name="products[{{ $i }}][feeRates][{{ $k1 }}][parameter]"
                                                                            value="{{ $feeRateLog->parameter }}">
                                                                    </td>
                                                                    <td class="text-center table-responsive"
                                                                        ...
                                                                        @if ($k == 0 && $k1 == 0)
                                                                            ...
                                                                            <table
                                                                                ...
                                                                                <tr>
                                                                                    <td class="text-center"
                                                                                        style="background-color: #d1cbba">
                                                                                        顥示號碼
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="text-center"
                                                                                        id="telecom_number"></td>
                                                                                </tr>
                                                                            </table>
                                                                        @endif
                                                                    </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <input type="number" class="form-control qty"
                                                                        id="qty_{{ $record->product_id }}"
                                                                        data-productid="{{ $record->product_id }}"
                                                                        name="products[{{ $i }}][qty]"
                                                                        value="{{ $value }}">
                                                                </td>
                                                                <td class="text-center">
                                                                    ...
                                                                    <input type="hidden"
                                                                        id="rent_month_{{ $record->product_id }}"
                                                                        name="products[{{ $i }}][rent_month]"
                                                                        value="{{ $record->product->rent_month }}">
                                                                </td>
                                                                <td class="text-center">
                                                                    @php
                                                                        $value = '';
                                                                    ...
                                                                    <input type="text" class="form-control discount"
                                                                        id="discount_{{ $record->product_id }}"
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    @endphp
                                                                    <input type="text" class="form-control"
                                                                        name="products[{{ $i }}][security_deposit]"
                                                                        value="{{ $value }}">
                                                                </td>
                                                                <td class="text-center">
                                                                    @php
...
@section('js')
    ...
    <script>
        ...
        var convertToBase64 = function(areaName, idName) {
            ...
            $(i).appendTo($("#" + areaName));
            $('#' + areaName).append('<input type="hidden" name="' + fieldName + '" id="' + fieldName + '" value="' +
                datapair + '">');
            $("#" + idName).hide();
